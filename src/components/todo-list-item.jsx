...
export default class TodoListItem extends React.Component {
  ...
  render() {
    const { label, onDeleted, important = false, onToggleDone, done, date } = this.props;
    const style = {
      color: important ? "tomato" : "black",
    };

    let classNameLabel = 'list-item-label'
    ...
    return (
      <div className={classNameItem}>
        ...
        <div className="list-btn">
          ...
          <button className="list-btn-done" onClick={onToggleDone}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
